...
extern void readMOXData();

extern void sps_init();
extern bool probing_sps30(uint8_t max_val);
...
/* Range time without connect before Shut Down Mode starts (2000 sec) */
#define RANGE_TIME_WITHOUT_CONNECTED  2000000
